      ...
      <section className="bg-primary py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            <p className="text-lg text-primary-foreground/80 leading-relaxed">בשנת 2022 החלה פעילותה של פורום מובילים יחד מתוך אמונה בדור הצעיר ואנשי עשייה  של יוצאים אתיופיה בישראל שהאמינו בכוחה של אחדות, שותפות ועבודה מול מקבלי ההחלטות במוסדות הממשלתיים הרלוונטים מתוך תחושת שליחות.הפורום הוקמה בשנת 2024 עמותת פורום מובילים יחד (ע"ר 580795821) — ומאז פועל הפורום להצמיח דור חדש של מנהיגים ציבוריים מהשטח.
