...
const boardMembers = [
{
  ...
  title: "נשיא העמותה",
  badge: "נשיא כבוד",
  photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Addisu_Massele_2014.jpg/320px-Addisu_Massele_2014.jpg",
  bio: `אדיסו מאסלה הוא חבר כנסת לשעבר ופעיל חברתי בכיר, הידוע כחבר הכנסת האתיופי הראשון בתולדות מדינת ישראל. כיהן כחבר כנסת מטעם מפלגת העבודה ונחשב לאחד מסמלי השילוב האתיופי בפוליטיקה הישראלית.

לאורך קריירתו הציבורית פעל למען שוויון זכויות, ייצוג הולם לקהילה האתיופית-ישראלית וקידום ערכי דמוקרטיה ושיתוף אזרחי. עומד בראש הפורום כנשיא העמותה ומשמש מנחה ומוביל לדור הצעיר של מנהיגי הקהילה.

"אנחנו לא אורחים בחברה הישראלית — אנחנו שותפים מלאים בבנייתה."`,
  linkedin: "#"
},
{
  name: "אבי יצחק",
