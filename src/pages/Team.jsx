...
בוגר תואר שני M.A. ומייסד הפורום, מוביל עשייה חברתית רחבת היקף ושותף לאקטיביזם ארצי למען שוויון זכויות, צדק חברתי ויצירת שינוי אמיתי בחברה הישראלית.
...
{
  name: "גילת אבבה",
  title: "דוברת ומזכירת העמותה",
  badge: "ממייסדי העמותה",
  photo: "https://media.base44.com/images/public/6a0ee0cfd572440ff8443041/aa9b1a9e6_WhatsAppImage2026-06-23at103309.jpeg",
  bio: `תואר ראשון B.A במדעי החברה והרוח, התמחות ניהול ארגוני חברתי. דוברת ומזכירת העמותה, מייסדת וחברת העמותה.

"האני המאמין שלי הוא לפעול בעולם מתוך אמביציה יזמית וחוסן אישי אבל לעשות זאת תמיד בעיניים פקוחות של חוקרת ובלב רגיש של הומניסטית וביושרה ובמחויבות אתית בלתי מתפשרת. פורום מובילים יחד הוא בדיוק המקום שיש בו תשתית נהדרת לא מתפשרת עם חזון אשר מתיישר עם הערכים שלי ובזכות כך זה מאפשר לי ליצור ליזום לסייע ולהעניק לכלל החברה ולחיות בעולם טוב יותר."`,
  linkedin: "#"
},
{
  name: "ציון סהלו",
...
const professionalTeam = [
{
  name: "נשיא העמותה",
  title: "נשיא העמותה",
  badge: "תפקיד ללא איוש",
  bio: "תפקיד זה טרם אויש. הפורום מחפש מנהיג/ה מתאים/ה לתפקיד נשיא העמותה.",
  linkedin: "#"
},
{
  name: "מנהל/ת קשרי חוץ",
  title: "מנהל.ת קשרי חוץ",
  badge: "תפקיד ללא איוש",
  bio: "תפקיד זה טרם אויש. הפורום מחפש מנהיג/ה מתאים/ה לתפקיד מנהל/ת קשרי חוץ.",
  linkedin: "#"
},
{
